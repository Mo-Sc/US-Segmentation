...
# set spacing manually to be able to compare HSD95 between algorithms independent of the px size
SPACING = [
    0.19047619047619,
    0.19047619047619,
    0.19047619047619,
...
def compute_metrics(
    ...
    for r in labels_or_regions:
        ...
        hsd95 = compute_hausdorff_distance(
            o_pred, o_ref, percentile=95.0, spacing=SPACING
        ).numpy()[0][0]
        ...
        print(
            f"Region {r}: Dice {results['metrics'][r]['Dice']}, IoU {results['metrics'][r]['IoU']}, HSD95 {results['metrics'][r]['HSD95']}"
        )
    return results
